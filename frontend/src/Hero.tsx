    ...
    <div className="relative min-h-screen flex items-center justify-center py-20 bg-black"> 
      ...
      <div className="text-center px-4 sm:px-6 lg:px-7 relative z-10"> 
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
          <button className="px-8 py-4 bg-blue-600 hover:bg-blue-700 text-white font-semibold rounded-xl shadow-lg transition-all duration-200 hover:scale-105 transform">
              Start Demo
          </button>
